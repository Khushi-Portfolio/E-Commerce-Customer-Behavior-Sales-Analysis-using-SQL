...
| Device_Type              | Device used for purchase                       |
| Session_Duration_Minutes | Time spent on the website                      |
| Pages_Viewed             | Number of pages viewed during session          |
| Is_Returning_Customer    | Indicates whether customer is returning or new |
